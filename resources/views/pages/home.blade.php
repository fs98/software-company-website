...
<section class="my-5" id="sliderSection">
  <!-- Swiper -->
        ...
        <div class="tabs shadow">
          ...
          <ul>
            <li title="Features"><label for="tab1" role="button"><svg viewBox="0 0 24 24">
                ...
                </svg><br><span>Web dizajn</span></label></li>
            <li title="Delivery Contents"><label for="tab2" role="button"><svg viewBox="0 0 24 24">
                ...
                </svg><br><span>Mobilne aplikacije</span></label></li>
          ...
          <div class="content">
            <section>
              <h2>Web stranice</h2>
              Katrieldev tim web stranicu vaše tvrtke će pretvoriti u online izlog. Vaše usluge i proizvode 
              učinit ćemo dostupnim u svakom trenutku, osigurati brzu, laku i jednostavnu nadogradnju 
              svih web stranica.
            </section>
            <section>
              <h2>Mobilne aplikacije</h2>
              Neograničene mogućnosti se otvaraju na dohvatu vaše ruke, naš tim će napraviti savršenu mobilnu aplikaciju koja će probiti granice vašeg trenutnog posla.
            </section>
            <section>
              <h2>Web shopovi</h2>
              Izbrišite granice i vrata svoje trgovine otvorite cijelom svijetu. Izuzetna pogodnost za kupce i za Vas je činjenica da je web trgovina otvorena 24 sata na dan, 365 dana u godini te je svaki željeni proizvod dostupan u nekoliko klikova.
            </section>
            <section>
